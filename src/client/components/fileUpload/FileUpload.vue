...
export default {
  ...
  render (h) {
    return (
      <label class={{'file-uploads': true,'file-uploads-html5': this.mode == 'html5','file-uploads-html4': this.mode == 'html4','btn':true, 'btn-primary':true}} >
  ...
  methods: {
    ...
    _addInputFileElement(el) {
      ...
      } else if (typeof Component._Ctor == 'function') {
